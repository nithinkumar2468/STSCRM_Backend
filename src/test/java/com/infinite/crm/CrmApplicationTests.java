 ...
 * com.infinite.crm.model.Products; import
 * com.infinite.crm.repository.ProductRepository; import
 * com.infinite.crm.service.ProductService;
 * 
 * 
 * @RunWith(MockitoJUnitRunner.class)
 * 
 * @SpringBootTest public class CrmApplicationTests {
 * 
 * 
 * 
 ...
 * 
 * @Test public void getallProducts() {
 * when(repository.findAll()).thenReturn(Stream.of (new
 * Products(2L,"Samsung","4",20000L,"samsung"), new
 * Products(4L,"Realme","5",20000L,"realme")) .collect(Collectors.toList()));
 * System.out.println(service.productList());
 * assertEquals(2,service.productList().size()); }
 * 
 * @Test public void getProductbyId() { Long id = 2L;
 * 
